...
public class DataLoaderTests(ITestOutputHelper output)
{
    ...
    public void ClearAllEntries()
    {
        ...
        var cache = new PromiseCache2(10);
        var options = new DataLoaderOptions2() { Cache = cache, };
        ...
        bool batching)
    {
        ...
        using var cacheOwner = caching
            ? new PromiseCacheOwner2()
            : null;

        var options = new DataLoaderOptions2
        {
    ...
    public async Task Add_Additional_Lookup_With_CacheObserver()
    {
        ...
        var dataLoader1 = new TestDataLoader1(
            ...
            new DataLoaderOptions2 { Cache = cache });
    ...
    private class TestDataLoader1(
        ...
        : DataLoaderBase2<int, Entity>(batchScheduler, options)
    {
    ...
    private class TestDataLoader2 : DataLoaderBase2<int, Entity>
    {
